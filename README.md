...
1. What category does this problem naturally live in? (Objects, morphisms, and a monoidal structure.)
2. What adjunctions preserve its essential invariants? (Left adjoint = abstraction, right adjoint = refinement.)
3. When the forward map is not invertible, what *quotient* or *subobject* characterises the solution set?
